    ...
    <div className="min-h-screen bg-gray-50/50">
      ...
      <div className="p-4 xl:ml-80">
        ...
        <div className="mt-12">
            ...
            <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
              <div className="bg-clip-border mx-4 rounded-xl overflow-hidden bg-gradient-to-tr from-orange-600 to-orange-400 text-white shadow-orange-500/40 shadow-lg absolute -mt-4 grid h-16 w-16 place-items-center">
                <svg
                  ...
                  <path
                    fillRule="evenodd"
                    d="M3.97 5.47a.75.75 0 011.06 0l5.22 5.22V3.75a.75.75 0 011.5 0v6.94l5.22-5.22a.75.75 0 111.06 1.06l-5.22 5.22h6.94a.75.75 0 010 1.5h-6.94l5.22 5.22a.75.75 0 01-1.06 1.06l-5.22-5.22v6.94a.75.75 0 01-1.5 0v-6.94l-5.22 5.22a.75.75 0 01-1.06-1.06l5.22-5.22H3.75a.75.75 0 010-1.5h6.94l-5.22-5.22a.75.75 0 010-1.06z"
                    clipRule="evenodd"></path>
                </svg>
              </div>
              <div className="p-4 text-right">
              ...
              <div className="border-t border-blue-gray-50 p-4">
                <p className="block antialiased font-sans text-base leading-relaxed font-normal text-blue-gray-600">
                  <strong className="text-green-500">+5%</strong>&nbsp;than last
                  month
                </p>
              </div>
            </div>
          ...
          {/* Projects Table */}
          <div className="mb-12 grid grid-cols-1 gap-y-10 gap-x-6 xl:grid-cols-3">
            <div className="col-span-2">
              <div className="relative flex flex-col bg-clip-border rounded-xl bg-white text-gray-700 shadow-md">
                <div className="p-4">
                  <h6 className="block antialiased font-sans text-base font-semibold leading-relaxed text-blue-gray-900">
                    Projects
                  </h6>
                </div>
                <div className="p-4 overflow-x-auto">
                  <table className="min-w-full divide-y divide-blue-gray-50 text-left">
                    <thead>
                      <tr>
                        <th className="whitespace-nowrap p-4 font-sans text-xs font-bold uppercase text-blue-gray-400">
                          Companies
                        </th>
                        <th className="whitespace-nowrap p-4 font-sans text-xs font-bold uppercase text-blue-gray-400">
                          Budget
                      ...
                      <tr>
                        <td className="whitespace-nowrap px-4 py-3">
                          <div className="flex items-center gap-4">
                            <img
                              src="https://demos.creative-tim.com/test/corporate3/assets/img/logos/logo-spotify.svg"
                              alt="spotify"
                              className="h-9 w-9 rounded-full"
                            />
                            <div>
                              <p className="block antialiased font-sans text-sm font-semibold leading-normal text-blue-gray-900">
                                Spotify
                              </p>
                              <p className="block antialiased font-sans text-xs font-normal leading-tight text-blue-gray-400">
                                Paid
                              </p>
                            </div>
                          </div>
                        ...
                        <td className="whitespace-nowrap p-4">
                          <p className="block antialiased font-sans text-xs font-semibold leading-tight text-blue-gray-600">
                            $2,500
                          </p>
                        </td>
                        <td className="whitespace-nowrap p-4">
                          <div className="w-10/12">
                            <div className="mb-0.5 flex items-center gap-2">
                              <span className="block antialiased font-sans text-xs font-medium leading-normal text-blue-gray-400">
                                60%
                              </span>
                            </div>
                            <div className="h-0.75 w-full rounded-lg bg-blue-gray-50">
                              <div className="h-full w-3/5 rounded-lg bg-gradient-to-tr from-blue-600 to-blue-400"></div>
                            </div>
                          </div>
                        </td>
                      </tr>
                      {/* More rows can be added here in a similar fashion */}
                    </tbody>
                  </table>
                </div>
              </div>
